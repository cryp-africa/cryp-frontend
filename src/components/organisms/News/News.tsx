    ...
    <div className="px-5 bigLaptop:px-20">
      {NewsData.map((news) => (
        <div className={`${news.id !== NewsData.length ? "mb-40" : "pb-20 bigLaptop:pb-40"}`} key={news.id}>
          ...
          <div className="flex items-center smallLaptop:items-start bigLaptop:items-center flex-col  bigLaptop:flex-row">
            ...
            <div className="w-full bigLaptop:w-1/2">
              ...
              <p className="text-14 font-medium w-full bigLaptop:w-[80%] text-white opacity-70 mb-8">{news.body}</p>
              <CustomLink
                customClass="text-12 smallLaptop:text-16 hover:text-crypYellow-300 font-semibold text-crypYellow-200 flex items-center justify-end bigLaptop:justify-start"
                destination="#"
              >
