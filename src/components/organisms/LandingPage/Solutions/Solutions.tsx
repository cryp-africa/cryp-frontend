...
const Solutions = () => {
  return (
    <div className="mb-16 smallLaptop:mb-32 tablet:ml-0">
      <h1 className="text-center capitalize font-semibold text-20 tablet:text-24 smallLaptop:text-[2.938rem] mb-8 smallLaptop:mb-24 leading-[3.438rem] ">our solutions for your business</h1>
      <div className="flex tablet:items-center flex-col bigLaptop:flex-row justify-center w-full relative ]">
        {SolutionsData.map((solution) => (
          ...
          >
            ...
            <h2 className="text-37 tablet:text-[6.25rem] font-bold text-right tablet:text-center text-crypGreen-800 uppercase mt-8 tablet:mt-16 mb-12 tablet:mb-16 smallLaptop:mb-20 desktop:mb-12">{solution.title}</h2>
            ...
            <div className="flex items-center tablet:justify-center">
              <p className="text-12 smallLaptop:text-16 text-white opacity-70 text-left tablet:text-center mt-12 mb-12 tablet:mb-32 w-full tablet:w-3/4 font-medium ">{solution.body}</p>
            </div>
