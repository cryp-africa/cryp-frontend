...
const Solutions = () => {
  return (
    <div className="mb-32">
      <h1 className="text-center capitalize font-semibold text-20 tablet:text-[2.938rem] mb-12 leading-[3.438rem] ">our solutions for your business</h1>
      <div className="flex tablet:items-center flex-col tablet:flex-row justify-center w-full relative">
        {SolutionsData.map((solution) => (
          <div
            className="bg-slate-800 w-full min-h-[17.813rem] h-auto  tablet:w-[36rem] tablet:h-[35.75rem] rounded-lg mx-8 mb-8 tablet:mb-0 p-6 tablet:p-12 relative"
            key={solution.id}
          >
            ...
            <h2 className="text-37 tablet:text-[6.25rem] font-bold text-right tablet:text-center text-crypGreen-800 uppercase mt-16 mb-40">{solution.title}</h2>
