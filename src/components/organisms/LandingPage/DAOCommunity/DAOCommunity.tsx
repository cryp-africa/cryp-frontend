  ...
  return (
    <div className="flex justify-center items-center relative">
      <div className="relative w-[76%]">
        ...
        <div className="flex rounded-md overflow-x-scroll py-16 hide-scrollbar scroll-smooth flex-nowrap relative" id="dao">
          {DAOCommunityData.map((dao) => (
            <div className="mx-4 relative basis-auto w-[389px] shrink-0 grow-0" key={dao.id}>
