...
const Building = ({ focusOnSubscribe }: any) => {
  return (
    <div className="mt-16 absolute top-[20%]">
      <h3 className="text-[30px] leading-[3.5rem] tablet:leading-[4rem] smallLaptop:leading-[5rem] desktop:leading-[6.375rem] tablet:text-[40px] smallLaptop:text-[45px] desktop:text-[4rem] tablet:w-full  tablet:font-medium">
